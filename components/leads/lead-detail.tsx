...
import { Pencil, Save, X, Phone, Mail, Calendar, Wallet, Globe, User, History, TrendingUp, Percent, MessageSquare, Copy, Check, ChevronDown, Search, FileText, Banknote, Calculator, ClipboardList } from 'lucide-react'
